package ru.mirea.kris.kris.lab5.data
...
interface CatApi {
    companion object{
        const val key = "x-api-key: 58a48431-0429-4fc6-8e66-6c06b24137da"
        const val sub_id = "MIREA_RPP_lab5_Grachev"
    }
    ...
    @GET("votes")
    fun getVotes(
        @Query("sub_id") sub_id: String = CatApi.sub_id
    ): Call<List<Vote?>?>?
